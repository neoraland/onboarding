...
const ProgressionBar = () => {
  ...
  return (
    <div className="p-5 w-full relative  lg:mt-10">
      {/* bar */}
            ...
            <span
              ...
              className={`${
                step.isActive
                  ...
                  : "bg-zinc-200"
              } w-[45px] h-[45px] lg:w-[50px] lg:h-[50px] rounded-full grid place-items-center border-4 border-white text-sm lg:text-lg cursor-pointer hover:bg-neora-blue-faded hover:text-white`}
            >
              {step.id + 1}
            </span>
          );
